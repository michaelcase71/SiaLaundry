...
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/add/master/karyawan.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/update/master/karyawan.php";
