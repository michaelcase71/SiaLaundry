...
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/add/master/supplier.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/update/master/supplier.php";
