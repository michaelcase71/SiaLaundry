<div>
    <div class="modal fade" id="modalharganupdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form method="POST" action="webservices/update.php" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="md-3">
                                    <input name="id_berat" type="hidden" class="form-control" id="idbrt" readonly>
                                </div>
                                <div class="mb-3">
                            <label for="nama" class="form-label">Kilogram</label>
                            <input type="text" class="form-control" name="kilogram" id="kg" required>
                        </div>
                        <div class="mb-3">
