...
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/add/master/hargaberat.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/SiaLaundry/pages/update/master/hargaberat.php";
